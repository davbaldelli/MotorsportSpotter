...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val handler = { location : Location ->
            ...
            eventViewModel.allEvents.observe(viewLifecycleOwner) { events -> adapter.submitList(EntitiesFilter.filterEventsByCountry(DBEntitiesConvertersFactory.EventConverter.convertAll(events), address.countryCode, requireContext()))}
        }
