...
abstract class EventDatabase : RoomDatabase() {
    ...
    private class EventDatabaseCallback(private val scope: CoroutineScope) : RoomDatabase.Callback() {
        ...
        suspend fun populateDatabase(eventDao: EventDao, trackDao: TrackDao, championshipDao: ChampionshipDao) {
            ...
            trackDao.insert(Track(12, "27.451154880579313, -81.35361188899327", "Sebring International Raceway", "https://i.imgur.com/rXyU9E0.jpg", "https://i.imgur.com/8wMNOkD.png"))
            trackDao.insert(Track(13, "47.956346471012736, 0.20774175218750832", "Circuit de la Sarthe", "https://i.imgur.com/TX3Q2fD.jpg", "https://i.imgur.com/zs4KUtw.png"))
            trackDao.insert(Track(14, "35.372882282577514, 138.92879996887177", "Fuji Speedway", "https://i.imgur.com/11ADibg.jpg", "https://i.imgur.com/x0OpZUR.jpg"))
            trackDao.insert(Track(15, "26.03694764332214, 50.51072123981255", "Bahrain International Circuit", "https://i.imgur.com/wToPBVm.jpg", "https://i.imgur.com/39Wh6uz.png"))
